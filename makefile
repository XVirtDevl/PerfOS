...
ld -z max-page-size=0x1000 -nostdlib -m elf_x86_64 -T ./kernel/link.ld -o ./bin/kernel.bin ./bin/kernel.elf ./bin/video.elf ./bin/apic.elf ./bin/exception.elf ./bin/processor.elf
